...
import 'package:empire/feature/product/presentation/views/add_subcategorys.dart/subcatergory_adding.dart';
import 'package:empire/feature/product/presentation/views/add_subcategorys.dart/widget.dart';
import 'package:empire/feature/product/presentation/views/categories/widgets.dart';
...
class AddSubcategory extends StatelessWidget {
  ...
  AddSubcategory({super.key, required this.mainCtiegoryid});
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) {
                  return AddCategoryWidget(id: mainCtiegoryid);
                },
              ),
            );
          },
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          context.read<SubCategoryBloc>().add(
            GetSubCategoryEvent(mainCtiegoryid),
          );
