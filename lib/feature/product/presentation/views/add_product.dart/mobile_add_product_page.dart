...
class MobileAddProdutsPage extends StatefulWidget {
  ...
  @override
  State<MobileAddProdutsPage> createState() => _MobileAddProdutsPageState();
}

class _MobileAddProdutsPageState extends State<MobileAddProdutsPage> {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<ImageAuth>(
          create: (_) =>
              ImageAuth(  pickImageFromCameraUsecaseUseCase: sl<PickImageFromCameraUsecase>(), pickImageFromGalleryusecaseUseCase: sl<PickImageFromGalleryusecase>(),)
        ),
        BlocProvider(
          create: (context) =>
              BrandBloc( sl<AddBrandUseCase>(),sl<GetBrandsUseCase>())
                ..add(
                  BrandFetching(
                        ...
                        children: AnimationConfiguration.toStaggeredList(
                          ...
                          children: [
                            ...
                            BlocBuilder<ProductBloc, ProductState>(
                              builder: (context, state) {
                                if (state is ProductSeletedState &&
